...
const Profile = () => {
  ...
  return (
    <div className="container mx-auto p-4 mt-[10rem]">
      <div className="flex justify-center align-center md:flex md:space-x-4 border shadow-lg p-10">
          ...
          <form onSubmit={submitHandler}>
            <div className="mb-4">
              ...
              <input
                ...
                className="form-input p-4 border border-black rounded-sm w-full"
                value={username}
